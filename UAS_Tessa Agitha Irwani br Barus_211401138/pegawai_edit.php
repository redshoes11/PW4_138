    ...
    <div class="container">
        <form class="mt-5" method="post">
            <div class="mb-3">
                ...
                name="nama" autocomplete="off" value=<?php echo $nama; ?>>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter Your Jenis Kelamin" 
                name="jk" autocomplete="off" value=<?php echo $jk; ?>>
            </div>
            <div class="mb-3">
                <label class="mb-3">Jabatan</label>
                <input type="text" class="form-control" placeholder="Enter Your Jabatan" 
                name="jabatan" autocomplete="off" value=<?php echo $jabatan; ?>>
            </div>
